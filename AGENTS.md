...
この repo は `voice-memo-transcription-audio-qa` の closed alpha 実装単位です。

## Scope

- Root: `D:\AI\WindowsApp\voice-memo-transcription-audio-qa`
- Domain: WindowsApp
- Product kind: windows-app
- Source pack: `D:/AI/WindowsApp/created_idea_006_voice-memo-transcription-audio-qa/idea_006_voice-memo-transcription-audio-qa.zip`
- Public repo: `https://github.com/Sunmax0731/voice-memo-transcription-audio-qa`

## Working Rules

- README、AGENTS、SKILL、docs を同じ変更単位で更新する。
- created_idea は `D:/AI/WindowsApp/created_idea_006_voice-memo-transcription-audio-qa` を正とし、同梱 ZIP の `metadata.json` と repo 名が一致することを確認する。
